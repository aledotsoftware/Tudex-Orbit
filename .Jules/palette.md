...
## 2024-07-02 - Restoring accessibility in Frutiger Aero / Glassmorphism UI
**Learning:** In the GeoCore Map Engine repository, Frutiger Aero / Glassmorphism UI styles often apply `outline: none` to buttons and inputs, breaking keyboard navigability. Also, isolated inputs without explicit labels are inaccessible to screen readers.
