...
## 2024-06-28 - Accessibility: Adding focus-visible to Frutiger Aero elements
**Learning:** In the GeoCore Map Engine repository, which utilizes Frutiger Aero / Glassmorphism UI styles, developers often apply `outline: none` to buttons and inputs to maintain the aesthetic, breaking keyboard accessibility.
